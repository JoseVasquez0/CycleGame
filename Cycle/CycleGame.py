...
black1=Image("black.jpg",game)
#Sound
click=Sound("switch.mp4",1)
#Resize
bwgs.resizeBy(-10)
logo.resizeBy(-30)
begin.resizeBy(-60)
...
black1.resizeTo(game.width,game.height)
#Character Variables
Age=10
Health=("Stable")
Quality=("Good")
...
while not game.over:
    ...
    for index in range(1):
        ...
        door_r.draw()
    game.drawText("Cycle",565,door_r.y-100,Font2)
...
while not game.over and not homework:
    game.processInput()
    bk2.draw()
    Education=("7th Grade")
    #Stats
...
#>
#THE TEACHER COLLECTS HW
while not game.over and homework:
    game.processInput()
    bk2.draw()
    Education=("7th Grade")
    #Stats
...
while not game.over and not give:
    game.processInput()
    bk2.draw()
    Education=("8th Grade")
    yell=False
...
while not game.over and not h:
    ...
    for index in range(1):
        ...
        if mouse.LeftClick and doors_r[index].collidedWith(mouse):
            ...
            game.over=True
    #Decision
    game.drawText("Your Mom Wants to Help Academically",150,30,Font2)
    #Choices
    #Left Choice
    game.drawText("OK",200,80,Font3)
    #Right Choice
    game.drawText("Say 'NO' Loudly",980,80,Font3)
    game.update(30)
game.over=False
#>
#YOU'VE BEEN OFFERED COCAINE
while not game.over and yell:
    game.processInput()
    bk2.draw()
    Education=("9th Grade")
    #Stats
...
game.quit()
#>
while not game.over and not h2:
    game.processInput()
    bk2.draw()
    Education=("10th Grade")
    #Stats
